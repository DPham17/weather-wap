...
export class HomePage {
  ...
  urlCalendar: string = 'https://www.googleapis.com/calendar/v3/calendars/' + this.email_1 + '/events?' + 'key=' + this.apiKeyCal;
  ...
  urlWeather: string = 'http://api.openweathermap.org/data/2.5/weather?q=' + this.city + '&appid=' + this.apiKeyW;
  ...
  getWeather() {
    this.http.get(this.urlWeather).subscribe(
